...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { correct: @option.correct, test_id: @option.test_id, word_option: @option.word_option } }, as: :json
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { correct: @option.correct, test_id: @option.test_id, word_option: @option.word_option } }, as: :json
    assert_response 200
  end
